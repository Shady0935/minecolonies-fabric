...
public interface ISurvivalBlueprintHandler
{
     ...
     * @return true if so.
     */
    boolean canHandle(final Blueprint blueprint, final Level level, final Player player, final BlockPos pos, final PlacementSettings placementSettings);

    /**
     * Handle the placement.
     * @param blueprint the blueprint to place.
     * @param structurePackId the id of the structurepack.
    ...
    void handle(
      ...
      final String blueprintPath, final boolean clientPack,
      final Level level,
      final Player player,
      final BlockPos pos,
