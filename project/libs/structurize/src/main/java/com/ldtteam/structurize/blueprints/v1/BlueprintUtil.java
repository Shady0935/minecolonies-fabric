...
public class BlueprintUtil
{
      ...
      Optional<BlockPos> anchorPos)
    {
        ...
        for (final Entity entity : entities)
        {
            ...
            final CompoundTag entityTag = EntityNbtUtils.save(entity);
    ...
    {
        // This fix relies on package-private Mojang DFU maps which are exposed by
        // Forge access transformers but not by vanilla/Fabric. New 1.20.1
        // blueprints do not need it; leave legacy data untouched rather than
        // depending on inaccessible implementation details.
    }
