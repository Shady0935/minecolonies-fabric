...
import com.ldtteam.structurize.api.util.IItemHandler;
...
public class InventoryUtils
{
    ...
    public static void consumeStack(final ItemStack tempStack, final IItemHandler handler)
    {
        ...
        final ItemStack container = tempStack.getItem().hasCraftingRemainingItem()
            ? new ItemStack(tempStack.getItem()) : ItemStack.EMPTY;
