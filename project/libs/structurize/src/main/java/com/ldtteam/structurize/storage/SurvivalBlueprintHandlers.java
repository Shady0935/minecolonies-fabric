...
public class SurvivalBlueprintHandlers
{
     ...
     * @return
     */
    public static List<ISurvivalBlueprintHandler> getMatchingHandlers(final Blueprint blueprint, final Level level, final Player player, final BlockPos pos, final PlacementSettings settings)
    {
