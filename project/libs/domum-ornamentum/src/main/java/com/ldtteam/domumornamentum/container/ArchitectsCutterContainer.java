            ...
            this.inputInventorySlots.add(
              this.addSlot(new Slot(this.inputInventory, i, x, y) {
                  ...
                  public boolean mayPlace(@NotNull final ItemStack stack)
                  {
                      ...
                      {
                          return MateriallyTexturedBlockManager.getInstance().doesItemStackContainsMaterialForSlot(this.index, stack);
                      }
                      else
                      {
                          return MateriallyTexturedBlockManager.getInstance().doesItemStackContainsMaterialForSlot(this.index, stack, currentVariant);
                      }
                  }
              })
            );
