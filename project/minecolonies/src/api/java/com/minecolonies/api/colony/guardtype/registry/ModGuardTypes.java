...
public final class ModGuardTypes
{
    ...
    public static FabricRegistryObject<GuardType> knight;
    public static FabricRegistryObject<GuardType> ranger;
    public static FabricRegistryObject<GuardType> druid;
