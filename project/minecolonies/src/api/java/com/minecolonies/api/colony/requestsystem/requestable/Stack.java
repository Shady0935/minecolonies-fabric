...
public class Stack implements IConcreteDeliverable
{
    ...
    public static CompoundTag serialize(final IFactoryController controller, final Stack input)
    {
        ...
        compound.put(NBT_STACK, input.theStack.save(new net.minecraft.nbt.CompoundTag()));
        ...
        {
            compound.put(NBT_RESULT, input.result.save(new net.minecraft.nbt.CompoundTag()));
        }
