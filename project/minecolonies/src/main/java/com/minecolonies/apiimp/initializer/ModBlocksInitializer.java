...
public final class ModBlocksInitializer
{
    ...
    {
        if (event.getRegistryKey().equals(FabricRegistries.Keys.BLOCKS))
        {
            ModBlocksInitializer.init(event.getFabricRegistry());
        }
    }
    ...
    public static void init(final FabricRegistry<Block> registry)
    {
    ...
    public static void registerItems(RegisterEvent event)
    {
        ...
        {
            ModBlocksInitializer.registerBlockItem(event.getFabricRegistry());
        }
    }
     ...
     */
    public static void registerBlockItem(final FabricRegistry<Item> registry)
    {
