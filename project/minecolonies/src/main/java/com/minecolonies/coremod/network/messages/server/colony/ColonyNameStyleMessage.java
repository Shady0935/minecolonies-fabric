...
public class ColonyNameStyleMessage extends AbstractColonyServerMessage
{
    ...
    /**
     * Creates a server-bound style message without requiring a client colony view.
     *
     * @param dimensionId colony dimension
     * @param colonyId colony id
     * @param style selected name style
     */
    public ColonyNameStyleMessage(final ResourceKey<Level> dimensionId, final int colonyId, final String style)
    {
