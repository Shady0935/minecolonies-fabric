...
public class ToolModuleWindow extends AbstractModuleWindow
{
    ...
    public ToolModuleWindow(final String res, final IBuildingView building, final ToolModuleView moduleView)
    {
        ...
        findPaneOfTypeByID("desc", Text.class).setText(Component.translatable("com.minecolonies.coremod.gui.tooldesc." + FabricRegistries.ITEMS.getKey(moduleView.getTool()).getPath()));
