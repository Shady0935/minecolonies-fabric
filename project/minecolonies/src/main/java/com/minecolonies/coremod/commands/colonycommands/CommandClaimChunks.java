...
public class CommandClaimChunks implements IMCOPCommand
{
    ...
    public int onExecute(final CommandContext<CommandSourceStack> context)
    {
        ...
        final IChunkmanagerCapability chunkManager = com.minecolonies.fabric.capability.CapabilityHooks.getCapability(sender.level(), CHUNK_STORAGE_UPDATE_CAP, null).resolve().orElse(null);
