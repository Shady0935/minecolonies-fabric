...
122 tests, including the owner-controlled colony-rank permission envelope,
...
update, and the applied citizen-view and visitor-view updates, plus the three standalone
MultiPiston tests; its log and JUnit report are
`logs/minecolonies-gametest-s2c-visitor-view-verify2-20260924.log` and
`logs/minecolonies-gametest-s2c-visitor-view-verify2-20260924.xml`. The full package build also passes in
`logs/minecolonies-build-s2c-visitor-view-20260924.log`. It saved
...
6. MultiPiston's separate Fabric 1.20.1 module is implemented and its focused
   ...
   122-test MineColonies + MultiPiston run also passes. Keep it as a required
