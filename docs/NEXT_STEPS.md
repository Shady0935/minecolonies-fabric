...
118 tests, including the owner-controlled colony-rank permission envelope,
...
and pickup-request cycle, the actual S2C FarmField update path, plus the three standalone MultiPiston tests; its log
and JUnit report are
`logs/minecolonies-gametest-s2c-farm-field-update-20260924.log` and
`logs/minecolonies-gametest-s2c-farm-field-update-20260924.xml`. The full package build also passes in
`logs/minecolonies-build-s2c-farm-field-update-20260924.log`. It saved
...
6. MultiPiston's separate Fabric 1.20.1 module is implemented and its focused
   ...
   118-test MineColonies + MultiPiston run also passes. Keep it as a required
