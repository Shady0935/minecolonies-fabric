...
colony color/help and spy-hiring routes, citizen-inventory menu opening, and
...
real visitor entity. The latest clean Fabric GameTest run passes all 67
...
inherited listener dispatch. Its 66-test core batch also exercises real
