...
assigned-citizen worker/hut recall, Stone Smeltery recipe/menu routes and
...
real visitor entity. The latest clean Fabric GameTest run passes all 65
...
inherited listener dispatch. Its 64-test core batch also exercises real
