...
colony color/help and spy-hiring routes, and University worker-tick checkpoints are now
complete:
...
real visitor entity. The latest clean Fabric GameTest run passes all 66
...
inherited listener dispatch. Its 65-test core batch also exercises real
