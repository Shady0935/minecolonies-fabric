...
inventory binding, citizen-inventory transfer and University worker-tick
checkpoints are now
complete:
...
real visitor entity. The latest clean Fabric GameTest run passes all 62
...
inherited listener dispatch. Its 61-test core batch also exercises real
