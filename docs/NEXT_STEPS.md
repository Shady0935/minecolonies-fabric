...
update, and the applied citizen-view and visitor-view updates and research-manager state, plus the three standalone
MultiPiston tests; its log and JUnit report are
`logs/minecolonies-gametest-s2c-research-view-20260924.log` and
`logs/minecolonies-gametest-s2c-research-view-20260924.xml`. The full package build also passes in
`logs/minecolonies-build-s2c-research-view-20260924.log`. It saved
