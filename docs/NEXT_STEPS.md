...
real visitor entity. The latest clean Fabric GameTest run passes all 78
...
inherited listener dispatch. Its 77-test core batch also exercises real
...
decoration work-order creation, plantation/rally routes and University research actions; entity AI,
