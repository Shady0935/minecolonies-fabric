...
registration, research-manager, building-rename and University worker-tick checkpoints are now
complete:
...
real visitor entity. The latest clean Fabric GameTest run passes all 37
...
inherited listener dispatch. Its 36-test core batch also exercises real
client-to-server Town Hall rename, colony foundation, direct Town Hall
placement, hut/building rename, colony style settings, deconstructed-building style,
FarmField configuration, Builder work-order creation/selection,
...
2. Extend the Fabric GameTest/focused integration fixtures from the current
   representative server/client network coverage, including the real
     client-to-server Town Hall rename, colony foundation, direct Town Hall
      ...
      decoration work-order creation and University research actions, fishing-hook and citizen
     coverage to every
