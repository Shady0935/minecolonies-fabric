...
real visitor entity. The latest clean Fabric GameTest run passes all 35
...
inherited listener dispatch. Its 34-test core batch also exercises real
client-to-server Town Hall rename, colony foundation, direct Town Hall
placement, hut/building rename, colony style settings, Builder work-order creation/selection,
