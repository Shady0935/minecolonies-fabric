...
inventory binding and University worker-tick checkpoints are now
complete:
...
real visitor entity. The latest clean Fabric GameTest run passes all 61
...
inherited listener dispatch. Its 60-test core batch also exercises real
