...
marking, move-in policy and citizen pause/resume and
...
real visitor entity. The latest clean Fabric GameTest run passes all 47
...
inherited listener dispatch. Its 46-test core batch also exercises real
...
building dirty marking, colony move-in policy and citizen pause/resume,
   ...
   representative server/client network coverage, including the real
     client-to-server Town Hall rename, colony foundation, direct Town Hall
      placement, hut/building rename, Builder work-order creation/selection,
       decoration work-order creation, building reactivation, Miner level selection, Guard Tower patrol-mine assignment, building dirty marking, move-in policy and citizen pause/resume and University research actions, fishing-hook and citizen
     coverage to every
