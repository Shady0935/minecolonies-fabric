...
real visitor entity. The latest clean Fabric GameTest run passes all 39
...
inherited listener dispatch. Its 38-test core batch also exercises real
...
settings, Builder delivery priority, deconstructed-building style,
