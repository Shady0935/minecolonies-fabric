...
registration, research-manager, building-rename, building-reactivation and
...
real visitor entity. The latest clean Fabric GameTest run passes all 42
...
inherited listener dispatch. Its 41-test core batch also exercises real
...
building reactivation, deconstructed-building style,
   ...
   representative server/client network coverage, including the real
     client-to-server Town Hall rename, colony foundation, direct Town Hall
      placement, hut/building rename, Builder work-order creation/selection,
       decoration work-order creation, building reactivation and University research actions, fishing-hook and citizen
     coverage to every
