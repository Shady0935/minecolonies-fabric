...
report are `logs/minecolonies-gametest-s2c-visitor-refresh-20260924.log` and
`logs/minecolonies-gametest-s2c-visitor-refresh-20260924.xml`. The full package
build also passes in `logs/minecolonies-build-s2c-visitor-refresh-20260924.log`. It saved
