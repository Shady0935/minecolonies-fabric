...
- [x] Projectile impacts now dispatch the cancellable `ProjectileImpactEvent`
  ...
  is covered by the latest 53-test Fabric GameTest run
...
- [x] Latest 53-test Fabric GameTest run passes with clean saves for all three
  dimensions; its 52-test core batch covers event-dispatch
  ...
  `logs/minecolonies-gametest-c2s-miner-repair.log`
