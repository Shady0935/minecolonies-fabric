...
- The Fabric GameTest now covers server-side Colonial Town Hall creation,
  ...
  construction, ore/mining AI and resource delivery, passive farmer crop growth and field
...
- Authenticated in-game interaction with BlockUI screens (including the
  ...
  passive farmer crop growth/field placement and warehouse/courier delivery beyond the
  covered 24-block normal-CitizenAI two-cell harvest, Farmer-hut deposit,
  Courier pickup and Warehouse-rack delivery (two-cell crop removal, empty-field hoeing
